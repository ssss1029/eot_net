...
model.load_state_dict(torch.load("checkpoints/baseline_ImageNetR_classes/model.pth.tar")['state_dict'])
model.eval()
model.cuda()
...
val_losses_avg, val_top1_avg, val_top5_avg = validate(val_loader, model, criterion)
